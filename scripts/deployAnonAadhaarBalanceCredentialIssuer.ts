...
async function main() {
  ...
  const balanceCredentialIssuerDeployer =
    await AnonAadhaarBalanceCredentialIssuerDeployHelper.initialize([owner], true);
  ...
  const balanceCredentialIssuer = contracts.AnonAadhaarBalanceCredentialIssuer;
